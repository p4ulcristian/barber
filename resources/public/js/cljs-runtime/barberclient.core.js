...
var vec__75100 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(date_str,"-");
var year = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75100,(0),null);
var month = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75100,(1),null);
var day = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75100,(2),null);
...
barberclient.core.ajax_get = (function barberclient$core$ajax_get(p__75104){
var map__75105 = p__75104;
var map__75105__$1 = (((((!((map__75105 == null))))?(((((map__75105.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__75105.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__75105):map__75105);
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75105__$1,new cljs.core.Keyword(null,"url","url",276297046));
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75105__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75105__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
...
barberclient.core.ajax_post = (function barberclient$core$ajax_post(p__75107){
var map__75108 = p__75107;
var map__75108__$1 = (((((!((map__75108 == null))))?(((((map__75108.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__75108.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__75108):map__75108);
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75108__$1,new cljs.core.Keyword(null,"url","url",276297046));
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75108__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75108__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75108__$1,new cljs.core.Keyword(null,"params","params",710516235));
...
barberclient.core.ajax_get(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"url","url",276297046),"/get-employees-and-services",new cljs.core.Keyword(null,"handler","handler",-195596612),(function (p1__75110_SHARP_){
var data = cljs.reader.read_string.cljs$core$IFn$_invoke$arity$1(p1__75110_SHARP_);
...
console.log(["wat",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.first(data))].join(''));
...
barberclient.core.ajax_get(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"url","url",276297046),"/server-time",new cljs.core.Keyword(null,"handler","handler",-195596612),(function (p1__75111_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$variadic(barberclient.core.app_state,cljs.core.assoc,new cljs.core.Keyword(null,"actual-time","actual-time",-862199229),(function (){var time = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.second(cljs.reader.read_string.cljs$core$IFn$_invoke$arity$1(p1__75111_SHARP_)),":");
return (((60) * parseInt(cljs.core.first(time))) + parseInt(cljs.core.second(time)));
})(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"actual-date","actual-date",-1046107089),cljs.core.first(cljs.reader.read_string.cljs$core$IFn$_invoke$arity$1(p1__75111_SHARP_))], 0));
})], null));

barberclient.core.ajax_get(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"url","url",276297046),"/min-max-date",new cljs.core.Keyword(null,"handler","handler",-195596612),(function (p1__75112_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(barberclient.core.app_state,cljs.core.assoc,new cljs.core.Keyword(null,"min-max-date","min-max-date",-6666333),cljs.reader.read_string.cljs$core$IFn$_invoke$arity$1(p1__75112_SHARP_));
}),new cljs.core.Keyword(null,"error-handler","error-handler",-484945776),(function (){
return window.alert("Error today");
})], null));

return barberclient.core.ajax_get(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"url","url",276297046),"/shop-data",new cljs.core.Keyword(null,"handler","handler",-195596612),(function (p1__75113_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(barberclient.core.app_state,cljs.core.assoc,new cljs.core.Keyword(null,"shop-data","shop-data",-1796065883),cljs.reader.read_string.cljs$core$IFn$_invoke$arity$1(p1__75113_SHARP_));
}),new cljs.core.Keyword(null,"error-handler","error-handler",-484945776),(function (){
...
var vec__75114 = the_vector;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75114,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75114,(1),null);
return [barberclient.core.convert_to_time(start)," - ",barberclient.core.convert_to_time(end)].join('');
}
});
barberclient.core.router = reitit.frontend.router.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["/",new cljs.core.Keyword(null,"index","index",-1531685915)], null)], null));
...
return (function barberclient$core$convert_free_times_to_reservation_times_$_iter__75117(s__75118){
return (new cljs.core.LazySeq(null,((function (length){
return (function (){
var s__75118__$1 = s__75118;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__75118__$1);
if(temp__5735__auto__){
var s__75118__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__75118__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__75118__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__75120 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__75119 = (0);
while(true){
if((i__75119 < size__4522__auto__)){
var vec__75121 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__75119);
var brake_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75121,(0),null);
var brake_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75121,(1),null);
cljs.core.chunk_append(b__75120,(function (){var mod_on_start = cljs.core.mod(brake_start,(30));
...
var iter__4523__auto__ = ((function (i__75119,mod_on_start,brake_start__$1,vec__75121,brake_start,brake_end,c__4521__auto__,size__4522__auto__,b__75120,s__75118__$2,temp__5735__auto__,length){
return (function barberclient$core$convert_free_times_to_reservation_times_$_iter__75117_$_iter__75124(s__75125){
return (new cljs.core.LazySeq(null,((function (i__75119,mod_on_start,brake_start__$1,vec__75121,brake_start,brake_end,c__4521__auto__,size__4522__auto__,b__75120,s__75118__$2,temp__5735__auto__,length){
return (function (){
var s__75125__$1 = s__75125;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__75125__$1);
if(temp__5735__auto____$1){
var s__75125__$2 = temp__5735__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__75125__$2)){
var c__4521__auto____$1 = cljs.core.chunk_first(s__75125__$2);
var size__4522__auto____$1 = cljs.core.count(c__4521__auto____$1);
var b__75127 = cljs.core.chunk_buffer(size__4522__auto____$1);
if((function (){var i__75126 = (0);
while(true){
if((i__75126 < size__4522__auto____$1)){
var multiplier = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto____$1,i__75126);
cljs.core.chunk_append(b__75127,(brake_start__$1 + ((30) * multiplier)));

var G__75178 = (i__75126 + (1));
i__75126 = G__75178;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__75127),barberclient$core$convert_free_times_to_reservation_times_$_iter__75117_$_iter__75124(cljs.core.chunk_rest(s__75125__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__75127),null);
}
} else {
var multiplier = cljs.core.first(s__75125__$2);
return cljs.core.cons((brake_start__$1 + ((30) * multiplier)),barberclient$core$convert_free_times_to_reservation_times_$_iter__75117_$_iter__75124(cljs.core.rest(s__75125__$2)));
}
} else {
return null;
}
...
});})(i__75119,mod_on_start,brake_start__$1,vec__75121,brake_start,brake_end,c__4521__auto__,size__4522__auto__,b__75120,s__75118__$2,temp__5735__auto__,length))
,null,null));
});})(i__75119,mod_on_start,brake_start__$1,vec__75121,brake_start,brake_end,c__4521__auto__,size__4522__auto__,b__75120,s__75118__$2,temp__5735__auto__,length))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__75120),barberclient$core$convert_free_times_to_reservation_times_$_iter__75117(cljs.core.chunk_rest(s__75118__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__75120),null);
}
} else {
var vec__75128 = cljs.core.first(s__75118__$2);
var brake_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75128,(0),null);
var brake_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75128,(1),null);
return cljs.core.cons((function (){var mod_on_start = cljs.core.mod(brake_start,(30));
var brake_start__$1 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((0),mod_on_start))?brake_start:(brake_start + ((30) - mod_on_start)));
if((brake_start__$1 <= (brake_end - length))){
var iter__4523__auto__ = ((function (mod_on_start,brake_start__$1,vec__75128,brake_start,brake_end,s__75118__$2,temp__5735__auto__,length){
return (function barberclient$core$convert_free_times_to_reservation_times_$_iter__75117_$_iter__75131(s__75132){
return (new cljs.core.LazySeq(null,((function (mod_on_start,brake_start__$1,vec__75128,brake_start,brake_end,s__75118__$2,temp__5735__auto__,length){
return (function (){
var s__75132__$1 = s__75132;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__75132__$1);
if(temp__5735__auto____$1){
var s__75132__$2 = temp__5735__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__75132__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__75132__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__75134 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__75133 = (0);
while(true){
if((i__75133 < size__4522__auto__)){
var multiplier = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__75133);
cljs.core.chunk_append(b__75134,(brake_start__$1 + ((30) * multiplier)));

var G__75180 = (i__75133 + (1));
i__75133 = G__75180;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__75134),barberclient$core$convert_free_times_to_reservation_times_$_iter__75117_$_iter__75131(cljs.core.chunk_rest(s__75132__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__75134),null);
}
} else {
var multiplier = cljs.core.first(s__75132__$2);
return cljs.core.cons((brake_start__$1 + ((30) * multiplier)),barberclient$core$convert_free_times_to_reservation_times_$_iter__75117_$_iter__75131(cljs.core.rest(s__75132__$2)));
}
} else {
return null;
}
...
});})(mod_on_start,brake_start__$1,vec__75128,brake_start,brake_end,s__75118__$2,temp__5735__auto__,length))
,null,null));
});})(mod_on_start,brake_start__$1,vec__75128,brake_start,brake_end,s__75118__$2,temp__5735__auto__,length))
;
return iter__4523__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1((cljs.core.quot(((brake_end - length) - brake_start__$1),(30)) + (1))));
...
})(),barberclient$core$convert_free_times_to_reservation_times_$_iter__75117(cljs.core.rest(s__75118__$2)));
}
} else {
return null;
}
...
var brakes_emp = barberclient.core.free_times__GT_emp(cljs.reader.read_string.cljs$core$IFn$_invoke$arity$1(p1__75135_SHARP_));
...
var new_free_dates = cljs.reader.read_string.cljs$core$IFn$_invoke$arity$1(p1__75136_SHARP_);
...
}),new cljs.core.Keyword(null,"role","role",-736691072),"button"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.uk-width-auto","div.uk-width-auto",-1506646300),cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__75140 = new cljs.core.Keyword(null,"language","language",-1591107564).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(barberclient.core.app_state));
var G__75140__$1 = (((G__75140 instanceof cljs.core.Keyword))?G__75140.fqn:null);
switch (G__75140__$1) {
case "en":
...
})], null),((barberclient.core.has_chosen_QMARK_(new cljs.core.Keyword(null,"service","service",-1963054559)))?cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__75144 = new cljs.core.Keyword(null,"language","language",-1591107564).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(barberclient.core.app_state));
var G__75144__$1 = (((G__75144 instanceof cljs.core.Keyword))?G__75144.fqn:null);
switch (G__75144__$1) {
case "en":
...
})()):barberclient.core.tr(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hu","hu",-1762884758),"V\u00E1lassz szolg\u00E1ltat\u00E1st",new cljs.core.Keyword(null,"en","en",88457073),"Choose service"], null)))], null),(((!(barberclient.core.has_chosen_QMARK_(new cljs.core.Keyword(null,"service","service",-1963054559)))))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__75141_SHARP_,p2__75142_SHARP_){
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [barberclient.core.service,p2__75142_SHARP_], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),p1__75141_SHARP_], null));
...
console.log(["hello: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.rand_nth(cljs.core.get.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"brakes-emp","brakes-emp",-1136920633).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(barberclient.core.app_state)),time)))].join(''));
...
return (function (p1__75145_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this_id,new cljs.core.Keyword(null,"_id","_id",-789960287).cljs$core$IFn$_invoke$arity$1(p1__75145_SHARP_));
});})(this_id))
...
})()], null):null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.uk-grid-collapse.uk-flex.uk-flex-center.uk-padding-small","div.uk-grid-collapse.uk-flex.uk-flex-center.uk-padding-small",-2053102841),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"data-uk-grid","data-uk-grid",-1215416447),true], null),cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(((function (new_coll,vec__75149,the_key,coll){
return (function (p1__75146_SHARP_,p2__75147_SHARP_){
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [barberclient.core.one_brake,p2__75147_SHARP_], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),p1__75146_SHARP_], null));
});})(new_coll,vec__75149,the_key,coll))
,new_coll)], null)], null);
});
...
return (function (a){
return ((new cljs.core.Keyword(null,"actual-time","actual-time",-862199229).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(barberclient.core.app_state)) + (120)) < a);
});})(old_times))
,old_times());
} else {
return old_times();
...
});})(G__75154,G__75154__$1,old_times,the_times))
], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),(2)], null));

break;
case "hu":
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [barberclient.core.flatpickr,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),barberclient.core.get_chosen(new cljs.core.Keyword(null,"date","date",-1463434462)),new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"enable","enable",-1839114332),cljs.core.clj__GT_js(new cljs.core.Keyword(null,"free-dates","free-dates",1423036474).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(barberclient.core.app_state))),new cljs.core.Keyword(null,"dateformat","dateformat",788125747),"Y-m-d",new cljs.core.Keyword(null,"minDate","minDate",229610480),cljs.core.first(new cljs.core.Keyword(null,"min-max-date","min-max-date",-6666333).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(barberclient.core.app_state))),new cljs.core.Keyword(null,"maxDate","maxDate",1297159788),cljs.core.second(new cljs.core.Keyword(null,"min-max-date","min-max-date",-6666333).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(barberclient.core.app_state))),new cljs.core.Keyword(null,"inline","inline",1399884222),true,new cljs.core.Keyword(null,"locale","locale",-2115712697),"hu",new cljs.core.Keyword(null,"onChange","onChange",-312891301),((function (G__75154,G__75154__$1,old_times,the_times){
return (function (selected_dates,date_str,instance){
barberclient.core.set_chosen(new cljs.core.Keyword(null,"start","start",-355208981),null);
...
return (function (p1__75153_SHARP_){
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [barberclient.core.day_section,p1__75153_SHARP_], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),cljs.core.first(p1__75153_SHARP_)], null));
});})(old_times,the_times))
...
return (function (p1__75155_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(barberclient.core.app_state,cljs.core.assoc,new cljs.core.Keyword(null,"sending","sending",-1806704862),(function (){var G__75157 = p1__75155_SHARP_;
switch (G__75157) {
case "reserved":
...
})(),new cljs.core.Keyword(null,"on-blur","on-blur",814300747),(function (p1__75160_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(barberclient.core.app_state,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"validation","validation",-2141396518),new cljs.core.Keyword(null,"name","name",1843675177)], null),barberclient.core.validate_name(p1__75160_SHARP_.target.value));
}),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(barberclient.core.app_state),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-data","user-data",2143823568),new cljs.core.Keyword(null,"name","name",1843675177)], null)),new cljs.core.Keyword(null,"max-length","max-length",-254826109),"50",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__75161_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(barberclient.core.app_state,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-data","user-data",2143823568),new cljs.core.Keyword(null,"name","name",1843675177)], null),p1__75161_SHARP_.target.value);
}),new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),barberclient.core.tr(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hu","hu",-1762884758),"N\u00E9v",new cljs.core.Keyword(null,"en","en",88457073),"Name"], null))], null)], null)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.uk-margin","div.uk-margin",1820567476),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.uk-grid-collapse.uk-width-1-1.uk-grid","div.uk-grid-collapse.uk-width-1-1.uk-grid",739625875),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"data-uk-grid","data-uk-grid",-1215416447),"true"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.uk-input.uk-width-auto.uk-padding-remove-vertical","div.uk-input.uk-width-auto.uk-padding-remove-vertical",1354235333),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),"7px",new cljs.core.Keyword(null,"margin-right","margin-right",809689658),"7px"], null),new cljs.core.Keyword(null,"data-uk-icon","data-uk-icon",1809176669),"icon: receiver"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),"+36"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.uk-width-expand","div.uk-width-expand",2031751938),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.uk-input","input.uk-input",-1990973192),new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var G__75167 = new cljs.core.Keyword(null,"phone","phone",-763596057).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"validation","validation",-2141396518).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(barberclient.core.app_state)));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__75167)){
return "good-input";
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__75167)){
return "bad-input";
} else {
return null;
...
})(),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(barberclient.core.app_state),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-data","user-data",2143823568),new cljs.core.Keyword(null,"phone","phone",-763596057)], null)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__75162_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(barberclient.core.app_state,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user-data","user-data",2143823568),new cljs.core.Keyword(null,"phone","phone",-763596057)], null),p1__75162_SHARP_.target.value);
}),new cljs.core.Keyword(null,"on-blur","on-blur",814300747),(function (p1__75163_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(barberclient.core.app_state,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"validation","validation",-2141396518),new cljs.core.Keyword(null,"phone","phone",-763596057)], null),barberclient.core.validate_phone(p1__75163_SHARP_.target.value));
}),new cljs.core.Keyword(null,"type","type",1174270348),"tel",new cljs.core.Keyword(null,"max-length","max-length",-254826109),"9",new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),barberclient.core.tr(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hu","hu",-1762884758),"Telefonsz\u00E1m",new cljs.core.Keyword(null,"en","en",88457073),"Phone number"], null))], null)], null)], null)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.uk-margin.uk-grid-small.uk-child-width-auto.uk-grid","div.uk-margin.uk-grid-small.uk-child-width-auto.uk-grid",1969746272),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.uk-checkbox","input.uk-checkbox",-981725814),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"checkbox",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (){
...
return (function (p1__75164_SHARP_){
p1__75164_SHARP_.preventDefault();
...
console.log(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(barberclient.core.app_state)));
...
], null),barberclient.core.tr((function (){var G__75168 = new cljs.core.Keyword(null,"sending","sending",-1806704862).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(barberclient.core.app_state));
var G__75168__$1 = (((G__75168 instanceof cljs.core.Keyword))?G__75168.fqn:null);
switch (G__75168__$1) {
case "loading":
...
break;
case "success":
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.uk-text-center","div.uk-text-center",-1334382774),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),"Foglal\u00E1s\u00E1hoz a meger\u0151s\u00EDt\u0151 emailt elk\u00FCldt\u00FCk a(z) '"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"b","b",1482224470),new cljs.core.Keyword(null,"email","email",1415816706).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"user-data","user-data",2143823568).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(barberclient.core.app_state)))], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),"' email c\u00EDmre."], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.uk-text-right.uk-margin-large-top","div.uk-text-right.uk-margin-large-top",-308874785),new_button], null)], null);
...
return reagent.core.create_class(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),barberclient.core.home_render,new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),(function (p1__75170_SHARP_){
return barberclient.core.home_did_mount(p1__75170_SHARP_,coordinates);
})], null));
});
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.uk-card.uk-card-secondary.uk-grid-collapse.playfair","div.uk-card.uk-card-secondary.uk-grid-collapse.playfair",1727632253),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"data-uk-grid","data-uk-grid",-1215416447),true,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"background","background",-863952629),"#222"], null)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [barberclient.core.opening_hours], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [barberclient.core.contact], null),(cljs.core.truth_(coordinates)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [barberclient.core.google_maps,coordinates], null):null)], null);
});
...
barberclient.core.local_uri_QMARK_ = (function barberclient$core$local_uri_QMARK_(p__75171){
var map__75172 = p__75171;
var map__75172__$1 = (((((!((map__75172 == null))))?(((((map__75172.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__75172.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__75172):map__75172);
var uri = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__75172__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(request,new cljs.core.Keyword(null,"headers","headers",-835030129),(function (p1__75174_SHARP_){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, ["Accept","application/transit+json","x-csrf-token",barberclient.core._QMARK_csrf_token], null),p1__75174_SHARP_], 0));
}));
} else {
return request;
}
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(ajax.core.default_interceptors,cljs.core.conj,(function (){var G__75175 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),"default headers",new cljs.core.Keyword(null,"request","request",1772954723),barberclient.core.default_headers], null);
return (ajax.core.to_interceptor.cljs$core$IFn$_invoke$arity$1 ? ajax.core.to_interceptor.cljs$core$IFn$_invoke$arity$1(G__75175) : ajax.core.to_interceptor.call(null,G__75175));
})());
});
