...
return [(function (){var pred__66793 = cljs.core.instance_QMARK_;
var expr__66794 = reactive_val;
if(cljs.core.truth_((pred__66793.cljs$core$IFn$_invoke$arity$2 ? pred__66793.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__66794) : pred__66793.call(null,reagent.ratom.RAtom,expr__66794)))){
return "ra";
} else {
if(cljs.core.truth_((pred__66793.cljs$core$IFn$_invoke$arity$2 ? pred__66793.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__66794) : pred__66793.call(null,reagent.ratom.RCursor,expr__66794)))){
return "rc";
} else {
if(cljs.core.truth_((pred__66793.cljs$core$IFn$_invoke$arity$2 ? pred__66793.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__66794) : pred__66793.call(null,reagent.ratom.Reaction,expr__66794)))){
return "rx";
} else {
if(cljs.core.truth_((pred__66793.cljs$core$IFn$_invoke$arity$2 ? pred__66793.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__66794) : pred__66793.call(null,reagent.ratom.Track,expr__66794)))){
return "tr";
} else {
return "other";
}
